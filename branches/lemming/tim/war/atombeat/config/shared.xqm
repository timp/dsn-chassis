...
(:
 ...
 :)
declare variable $config:service-url as xs:string := "http://localhost:8081/lemming/atombeat/content" ;
...
(:
 ...
 :)
declare variable $config:history-service-url as xs:string := "http://localhost:8081/lemming/atombeat/history" ;
 

declare variable $config:acl-service-url as xs:string := "http://localhost:8081/lemming/atombeat/acl" ;
