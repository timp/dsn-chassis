...
/**
 * Generated event NextRevisionNavigation from StudyRevisionActions to 
 * ViewStudyRevision.
 *
 ...
 *
 */
public class NextRevisionNavigationEvent extends WidgetEvent {

	private static final Log log = LogFactory.getLog(NextRevisionNavigationEvent.class);	
