...
public class EditQuestionnaireWidget 
	...
	interface EditQuestionnaireWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, EditQuestionnaireWidget> {
	}
	...
	@UiField FlowPanel editQuestionnairePanel;
	...
	protected void syncUIWithStudyEntry(Element studyEntry) {
		...
		this.editQuestionnairePanel.clear();
		this.editQuestionnairePanel.add(strongWidget("syncUIWithStudyEntry"));
		log.leave();
	}
