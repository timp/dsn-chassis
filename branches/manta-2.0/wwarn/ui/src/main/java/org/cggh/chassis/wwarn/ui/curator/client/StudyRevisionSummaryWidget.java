...
public class StudyRevisionSummaryWidget 
	...
	interface StudyRevisionSummaryWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, StudyRevisionSummaryWidget> {
	}
	...
	@UiField FlowPanel studyRevisionSummaryPanel;
	...
	protected void syncUIWithStudyEntry(Element studyEntry) {
		...
		this.studyRevisionSummaryPanel.clear();
		this.studyRevisionSummaryPanel.add(strongWidget("syncUIWithStudyEntry"));
		log.leave();
	}
