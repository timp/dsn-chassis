...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="pharamacology.assayReferences" select="5"/>
    ...
    <xsl:template match="study-info">
        ...
        <!-- end of element name processing -->
    </xsl:template>
    ...
    <xsl:template match="drugs/drug">
        ...
        <xsl:call-template name="addDrugs">
            ...
            <xsl:with-param name="newpref" select="$newpref"/>
        </xsl:call-template>
        ...
        <xsl:for-each select="*">
            <xsl:choose>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:value-of
                        select="concat(concat($ing,$nname),1 + count(parent::*/preceding-sibling::*))"/>
                        -->
                    <xsl:value-of select="concat($parentNum,name(.))"/>
