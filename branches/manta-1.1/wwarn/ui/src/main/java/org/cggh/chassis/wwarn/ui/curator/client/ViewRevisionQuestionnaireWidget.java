...
public class ViewRevisionQuestionnaireWidget 
	...
	interface ViewRevisionQuestionnaireWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, ViewRevisionQuestionnaireWidget> {
	}
	...
	@UiField FlowPanel viewRevisionQuestionnairePanel;
	...
	protected void syncUIWithStudyEntry(Element studyEntry) {
		...
		this.viewRevisionQuestionnairePanel.clear();
		this.viewRevisionQuestionnairePanel.add(strongWidget("syncUIWithStudyEntry"));
		log.leave();
	}
