...
public class SecureEmailProcessor extends ProcessorImpl {
    ...
    private static final Logger logger = LoggerFactory.createLogger(SecureEmailProcessor.class);
    ...
    private static String getProperty(final Element parent, final String name) throws NamingException {
    	 final Element element = parent.element(name);
         
         String value = (element != null) ? element.getStringValue().trim() : null;
    ...
    public void start(PipelineContext pipelineContext) {
        try {
            ...
            if (testSmtpHostProperty != null) {
                ...
                String port = messageElement.element(EMAIL_SMTP_PORT);
...
// contentTypeFromAttribute.substring("multipart/".length());
    ...
    private void handlePart(PipelineContext pipelineContext, String dataInputSystemId, Part parentPart, Element partOrBodyElement) throws Exception {
        ...
        if (src != null) {
            ...
            final SAXSource source = getSAXSource(SecureEmailProcessor.this, pipelineContext, src, dataInputSystemId, contentType);
