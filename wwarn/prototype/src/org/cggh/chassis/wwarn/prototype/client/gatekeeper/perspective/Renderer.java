...
class Renderer implements BasePerspectiveModelListener {
	...
	private void createMainMenu() {
		...
		submissionMenu.addItem("pending requests", new SetMainWidgetCommand(controller, GatekeeperPerspective.WIDGET_PENDINGSUBMISSIONREQUESTS));
		submissionMenu.addItem("approved requests", new SetMainWidgetCommand(controller, GatekeeperPerspective.WIDGET_APPROVEDSUBMISSIONREQUESTS));
		submissionMenu.addItem("denied requests", new SetMainWidgetCommand(controller, GatekeeperPerspective.WIDGET_DENIEDSUBMISSIONREQUESTS));
		submissionMenu.addItem("all requests", new SetMainWidgetCommand(controller, GatekeeperPerspective.WIDGET_ALLSUBMISSIONREQUESTS));
		mainMenu.addItem("submission requests", submissionMenu);
