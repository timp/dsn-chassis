 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.coordinator.widget.deniedreqs;
 ...
 *
 */
public class CoordinatorWidgetDeniedSubmissionRequests extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetDeniedSubmissionRequests();
		}
	...
	public CoordinatorWidgetDeniedSubmissionRequests() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetDeniedSubmissionRequests.class.getName());
		this.initialise();
	}
