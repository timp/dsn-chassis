 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.curator.widget.allsubmissions;
 ...
 *
 */
public class CuratorWidgetAllSubmissions extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CuratorWidgetAllSubmissions();
		}
	...
	public CuratorWidgetAllSubmissions() {
		super();
		this.log.setCurrentClass(CuratorWidgetAllSubmissions.class.getName());
		this.initialise();
	}
