 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.curator.widget.newtask;
 ...
 *
 */
public class CuratorWidgetDelegateNewTask extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CuratorWidgetDelegateNewTask();
		}
	...
	public CuratorWidgetDelegateNewTask() {
		super();
		this.log.setCurrentClass(CuratorWidgetDelegateNewTask.class.getName());
		this.initialise();
	}
