...
<title>WWARN - Personal Data Review // <jsp:expression>user.getUsername()</jsp:expression></title>
...
var config = {
	...
	"formhandler.anonymizedfileupload.url" : "<jsp:expression>request.getContextPath()</jsp:expression>/anonymizer/upload"
};
</script>
<style>
#jsWarning {
...
<noscript>
	...
	<script type="text/javascript" language="javascript" src="../org.cggh.chassis.wwarn.ui.anonymizer.Anonymizer/org.cggh.chassis.wwarn.ui.anonymizer.Anonymizer.nocache.js">
		<!-- bootstrap script -->
	</script>
