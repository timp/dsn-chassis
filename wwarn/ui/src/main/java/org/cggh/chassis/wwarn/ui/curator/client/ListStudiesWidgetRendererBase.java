...
public abstract class ListStudiesWidgetRendererBase extends ChassisWidgetRenderer<ListStudiesWidgetModel> {

	protected Log log = LogFactory.getLog(ListStudiesWidgetRenderer.class);
	...
	private static ListStudiesWidgetRendererUiBinder uiBinder = GWT.create(ListStudiesWidgetRendererUiBinder.class);
	@UiField
	HTMLPanel mainPanel;
	@UiField
