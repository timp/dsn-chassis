 ...
 * @author timp
 */
public class SelectDerivationFilesWidgetRenderer extends
		ChassisWidgetRenderer<SelectDerivationFilesWidgetModel> {
	...
	private SelectDerivationFilesWidget owner;
  public SelectDerivationFilesWidgetRenderer(SelectDerivationFilesWidget owner) {
		this.owner = owner;
	}
