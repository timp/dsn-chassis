 ...
 * @since 13 Jan 2010
 */
public class StudyRevisionListWidgetRenderer extends
		ChassisWidgetRenderer<StudyRevisionListWidgetModel> {

	private Log log = LogFactory.getLog(StudyRevisionListWidgetRenderer.class);
	
	@UiTemplate("StudyRevisionListWidget.ui.xml")
	interface StudyRevisionListWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, StudyRevisionListWidgetRenderer> {
	}
...
//	@UiField FlowPanel mainActionsPanel;
	...
	public void setController(StudyRevisionListWidgetController controller) {
