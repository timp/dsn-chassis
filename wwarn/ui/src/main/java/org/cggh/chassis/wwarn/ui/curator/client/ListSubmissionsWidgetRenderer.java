 ...
 * @author timp
 */
public class ListSubmissionsWidgetRenderer extends
		ChassisWidgetRenderer<ListSubmissionsWidgetModel> {

	private Log log = LogFactory.getLog(ListSubmissionsWidgetRenderer.class);
	
	@UiTemplate("ListSubmissionsWidget.ui.xml")
	interface ListSubmissionsWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, ListSubmissionsWidgetRenderer> {
	}
