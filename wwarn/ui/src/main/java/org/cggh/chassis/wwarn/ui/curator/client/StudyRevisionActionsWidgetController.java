 ...
 *
 */
public class StudyRevisionActionsWidgetController {

	
	
	
	private Log log = LogFactory.getLog(StudyRevisionActionsWidgetController.class);
	
	
	
	
	private StudyRevisionActionsWidget owner;
	private StudyRevisionActionsWidgetModel model;


	
	
	public StudyRevisionActionsWidgetController(StudyRevisionActionsWidget owner, StudyRevisionActionsWidgetModel model) {
		this.owner = owner;
		this.model = model;
	}
	...
	private Deferred<Element> retrieveSubmission() {
		...
		model.status.set(StudyRevisionActionsWidgetModel.STATUS_RETRIEVE_SUBMISSION_PENDING);
...
//				model.studyEntryElement.set(studyEntryElement);
				...
				model.status.set(StudyRevisionActionsWidgetModel.STATUS_SUBMISSION_NOT_FOUND);
...
*/
	...
	public Deferred<Element> retrieveStudy() {
		...
		model.status.set(StudyRevisionActionsWidgetModel.STATUS_RETRIEVE_STUDY_PENDING);
	...
	public final Function<Element, Element> retrieveStudyCallback = new Function<Element, Element>() {
		...
		public Element apply(Element in) {
			...
			model.status.set(StudyRevisionActionsWidgetModel.STATUS_READY_FOR_INTERACTION);
	...
	public void saveStudy() {
		...
		model.status.set(StudyRevisionActionsWidgetModel.STATUS_SAVE_STUDY_PENDING);
