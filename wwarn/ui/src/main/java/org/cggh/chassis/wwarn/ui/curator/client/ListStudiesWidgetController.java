...
public class ListStudiesWidgetController {
	...
	private Deferred<Element> retrieveSubmission() {
		...
		model.status.set(ListStudiesWidgetModel.STATUS_RETRIEVE_SUBMISSION_PENDING);
...
//				model.studyEntryElement.set(studyEntryElement);
				...
				model.status.set(ListStudiesWidgetModel.STATUS_SUBMISSION_NOT_FOUND);
...
*/
	...
	public Deferred<Element> retrieveStudy() {
		...
		model.status.set(ListStudiesWidgetModel.STATUS_RETRIEVE_STUDY_PENDING);
	...
	public void saveStudy() {
		...
		model.status.set(ListStudiesWidgetModel.STATUS_SAVE_STUDY_PENDING);
