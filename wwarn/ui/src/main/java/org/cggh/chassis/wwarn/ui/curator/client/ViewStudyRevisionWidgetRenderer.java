...
public class ViewStudyRevisionWidgetRenderer extends
	...
	protected void registerHandlersForChildWidgetEvents() {
		log.enter("registerHandlersForChildWidgetEvents");
				...
				studyRevisionActionsWidgetUiField.studyRevisionActionsListStudiesNavigationEventChannel.addHandler(new WidgetEventHandler() {
 		...
 		this.childWidgetEventHandlerRegistrations.add(
				studyRevisionActionsWidgetUiField.studyRevisionActionsEditStudyQuestionnaireNavigationEventChannel.addHandler(new WidgetEventHandler() {
			public void onEvent(WidgetEvent e) {
 		...
 		this.childWidgetEventHandlerRegistrations.add(
				studyRevisionActionsWidgetUiField.studyRevisionActionsNextRevisionNavigationEventChannel.addHandler(new WidgetEventHandler() {
			public void onEvent(WidgetEvent e) {
 		...
 		this.childWidgetEventHandlerRegistrations.add(
				studyRevisionActionsWidgetUiField.studyRevisionActionsViewStudyQuestionnaireNavigationEventChannel.addHandler(new WidgetEventHandler() {
			public void onEvent(WidgetEvent e) {
 		...
 		this.childWidgetEventHandlerRegistrations.add(
				studyRevisionActionsWidgetUiField.studyRevisionActionsPreviousRevisionNavigationEventChannel.addHandler(new WidgetEventHandler() {
			public void onEvent(WidgetEvent e) {
 		...
 		this.childWidgetEventHandlerRegistrations.add(
				studyRevisionActionsWidgetUiField.studyRevisionActionsListStudyRevisionsNavigationEventChannel.addHandler(new WidgetEventHandler() {
			public void onEvent(WidgetEvent e) {
