 ...
 *
 */
public class ViewQuestionnaireWidgetController {

	
	
	
	private Log log = LogFactory.getLog(ViewQuestionnaireWidgetController.class);
	
	
	
	
	private ViewQuestionnaireWidget owner;
	private ViewQuestionnaireWidgetModel model;


	
	
	public ViewQuestionnaireWidgetController(ViewQuestionnaireWidget owner, ViewQuestionnaireWidgetModel model) {
		this.owner = owner;
		this.model = model;
	}
	...
	public Deferred<Element> retrieveStudy() {
		...
		model.status.set(ViewQuestionnaireWidgetModel.STATUS_RETRIEVE_STUDY_PENDING);
	...
	public final Function<Element, Element> retrieveStudyCallback = new Function<Element, Element>() {
		...
		public Element apply(Element in) {
			...
			model.status.set(ViewQuestionnaireWidgetModel.STATUS_READY_FOR_INTERACTION);
	...
	public void saveStudy() {
		...
		model.status.set(ViewQuestionnaireWidgetModel.STATUS_SAVE_STUDY_PENDING);
