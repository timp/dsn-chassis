 ...
 *
 */
public class ListCurationsWidget 
	 	extends ChassisWidget {

	private static final Log log = LogFactory.getLog(ListCurationsWidget.class);


	@UiTemplate("ListCurationsWidget.ui.xml")
	interface ListCurationsWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, ListCurationsWidget> {
	}
	...
	@UiField FlowPanel listCurationsPanel;
	...
	protected void syncUIWithStudyEntry(Element studyEntry) {
		...
		this.listCurationsPanel.clear();
		this.listCurationsPanel.add(strongWidget("syncUIWithStudyEntry"));
		log.leave();
	}
