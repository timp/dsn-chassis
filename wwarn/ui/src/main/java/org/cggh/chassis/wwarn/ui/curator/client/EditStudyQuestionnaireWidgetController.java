...
public class EditStudyQuestionnaireWidgetController {
	...
	public Deferred<Document> retrieveStudy() {
		...
		//model.setStatus(EditStudyQuestionnaireWidgetModel.STATUS_RETRIEVE_STUDIES_PENDING);
	...
	private class RetrieveStudyCallback implements Function<Element, Deferred<Document>> {
		...
		public Deferred<Document> apply(Element studyEntryElement) {
			...
			if (studyEntryElement != null) {
				...
				//model.setStatus(EditStudyQuestionnaireWidgetModel.STATUS_STUDY_NOT_FOUND);
