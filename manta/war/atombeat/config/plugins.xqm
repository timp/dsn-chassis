...
import module namespace tombstone-plugin = "http://purl.org/atombeat/xquery/tombstone-plugin" at "../plugins/tombstone-plugin.xqm" ;
...
declare function plugin:before() as function* {
	(
        ...
        util:function( QName( "http://purl.org/atombeat/xquery/tombstone-plugin" , "tombstone-plugin:before" ) , 4 ),
...
declare function plugin:after() as function* {
	(
        ...
        util:function( QName( "http://purl.org/atombeat/xquery/tombstone-plugin" , "tombstone-plugin:after" ) , 3 ) ,
