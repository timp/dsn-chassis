 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.submitter.widget.mysubmissions;
 ...
 *
 */
public class SubmitterWidgetMySubmissions extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new SubmitterWidgetMySubmissions();
		}
	...
	public SubmitterWidgetMySubmissions() {
		super();
		this.log.setCurrentClass(SubmitterWidgetMySubmissions.class.getName());
		this.initialise();
	}
