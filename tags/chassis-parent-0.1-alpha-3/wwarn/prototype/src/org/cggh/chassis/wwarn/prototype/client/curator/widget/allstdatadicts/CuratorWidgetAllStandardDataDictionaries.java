 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.curator.widget.allstdatadicts;
 ...
 *
 */
public class CuratorWidgetAllStandardDataDictionaries extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CuratorWidgetAllStandardDataDictionaries();
		}
	...
	public CuratorWidgetAllStandardDataDictionaries() {
		super();
		this.log.setCurrentClass(CuratorWidgetAllStandardDataDictionaries.class.getName());
		this.initialise();
	}
