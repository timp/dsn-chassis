 ...
 *
 */
public class CoordinatorWidgetAllSubmissions extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetAllSubmissions();
		}
	...
	public CoordinatorWidgetAllSubmissions() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetAllSubmissions.class.getName());
		this.initialise();
	}
