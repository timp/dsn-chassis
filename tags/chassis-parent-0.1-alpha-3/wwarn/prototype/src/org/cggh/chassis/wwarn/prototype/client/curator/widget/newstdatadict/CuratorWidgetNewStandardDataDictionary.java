 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.curator.widget.newstdatadict;
 ...
 *
 */
public class CuratorWidgetNewStandardDataDictionary extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CuratorWidgetNewStandardDataDictionary();
		}
	...
	public CuratorWidgetNewStandardDataDictionary() {
		super();
		this.log.setCurrentClass(CuratorWidgetNewStandardDataDictionary.class.getName());
		this.initialise();
	}
