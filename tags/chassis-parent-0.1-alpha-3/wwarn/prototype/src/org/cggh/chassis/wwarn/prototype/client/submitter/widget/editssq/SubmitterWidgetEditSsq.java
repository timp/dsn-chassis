 ...
 *
 */
public class SubmitterWidgetEditSsq extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new SubmitterWidgetEditSsq();
		}
	...
	private List<SubmitterWidgetEditSsqListener> listeners = new ArrayList<SubmitterWidgetEditSsqListener>();
	...
	public SubmitterWidgetEditSsq() {
		super();
		this.log.setCurrentClass(SubmitterWidgetEditSsq.class.getName());
		this.initialise();
	}
	...
	public void addListener(SubmitterWidgetEditSsqListener listener) {
		listeners.add(listener);
	}


	void fireStudyUpdateSuccess(StudyEntry study) {
		for (SubmitterWidgetEditSsqListener l : listeners) {
