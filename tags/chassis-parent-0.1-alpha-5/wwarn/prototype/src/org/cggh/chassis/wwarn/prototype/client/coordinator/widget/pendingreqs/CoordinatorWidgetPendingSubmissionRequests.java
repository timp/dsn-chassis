 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.coordinator.widget.pendingreqs;
 ...
 *
 */
public class CoordinatorWidgetPendingSubmissionRequests extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetPendingSubmissionRequests();
		}
	...
	public CoordinatorWidgetPendingSubmissionRequests() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetPendingSubmissionRequests.class.getName());
		this.initialise();
	}
