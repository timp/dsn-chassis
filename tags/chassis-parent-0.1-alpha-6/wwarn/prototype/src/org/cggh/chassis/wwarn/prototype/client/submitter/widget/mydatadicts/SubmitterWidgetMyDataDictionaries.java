 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.submitter.widget.mydatadicts;
 ...
 *
 */
public class SubmitterWidgetMyDataDictionaries extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new SubmitterWidgetMyDataDictionaries();
		}
	...
	public SubmitterWidgetMyDataDictionaries() {
		super();
		this.log.setCurrentClass(SubmitterWidgetMyDataDictionaries.class.getName());
		this.initialise();
	}
