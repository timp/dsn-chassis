 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.curator.widget.home;
 ...
 *
 */
public class CuratorWidgetHome extends FractalUIComponent {
	...
	public CuratorWidgetHome() {
		super();
		this.log.setCurrentClass(CuratorWidgetHome.class.getName());
		this.initialise();
	}
