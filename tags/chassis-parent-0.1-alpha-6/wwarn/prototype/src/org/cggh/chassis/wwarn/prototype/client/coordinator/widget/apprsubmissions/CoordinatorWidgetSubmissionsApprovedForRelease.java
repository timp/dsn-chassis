 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.coordinator.widget.apprsubmissions;
 ...
 *
 */
public class CoordinatorWidgetSubmissionsApprovedForRelease extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetSubmissionsApprovedForRelease();
		}
	...
	public CoordinatorWidgetSubmissionsApprovedForRelease() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetSubmissionsApprovedForRelease.class.getName());
		this.initialise();
	}
