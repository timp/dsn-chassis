 ...
 *
 */
public class SubmitterWidgetNewSubmission extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new SubmitterWidgetNewSubmission();
		}
	...
	public SubmitterWidgetNewSubmission() {
		super();
		this.log.setCurrentClass(SubmitterWidgetNewSubmission.class.getName());
		this.initialise();
	}
