 ...
 *
 */
public class CoordinatorWidgetHome extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetHome();
		}
	...
	public CoordinatorWidgetHome() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetHome.class.getName());
		this.initialise();
	}
