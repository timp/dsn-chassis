(: 
NOTE this file is filtered by Maven and overwrites the copy used by Eclipse 
NOTE ANY EDITS TO THIS FILE MUST BE DUPLICATED IN war/atombeat/config/shared.xqm
:) 
xquery version "1.0";
...
:)
declare variable $config:service-url-base as xs:string :=  "${targetHost}/manta/atombeat" ;
