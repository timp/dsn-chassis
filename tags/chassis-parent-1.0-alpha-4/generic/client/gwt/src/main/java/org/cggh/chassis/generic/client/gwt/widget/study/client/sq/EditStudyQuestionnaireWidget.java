...
public class EditStudyQuestionnaireWidget 
	extends AtomCrudWidget<StudyEntry, StudyFeed, StudyQuery, StudyQuestionnaireWidgetModel, EditStudyQuestionnaireWidgetRenderer, StudyQuestionnaireWidgetController>
	
{
	 ...
	 * @param id
	 */
	public Deferred<StudyEntry> editEntry(String url) {
