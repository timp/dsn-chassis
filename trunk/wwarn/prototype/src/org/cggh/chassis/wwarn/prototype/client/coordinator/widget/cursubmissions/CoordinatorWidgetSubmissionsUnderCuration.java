 ...
 *
 */
public class CoordinatorWidgetSubmissionsUnderCuration extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetSubmissionsUnderCuration();
		}
	...
	public CoordinatorWidgetSubmissionsUnderCuration() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetSubmissionsUnderCuration.class.getName());
		this.initialise();
	}
