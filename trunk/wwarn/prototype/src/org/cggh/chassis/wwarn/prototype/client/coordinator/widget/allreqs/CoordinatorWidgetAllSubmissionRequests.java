 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.coordinator.widget.allreqs;
 ...
 *
 */
public class CoordinatorWidgetAllSubmissionRequests extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetAllSubmissionRequests();
		}
	...
	public CoordinatorWidgetAllSubmissionRequests() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetAllSubmissionRequests.class.getName());
		this.initialise();
	}
