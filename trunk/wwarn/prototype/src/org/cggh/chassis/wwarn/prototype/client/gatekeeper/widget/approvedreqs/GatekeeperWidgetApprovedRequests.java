 ...
 *
 */
public class GatekeeperWidgetApprovedRequests extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new GatekeeperWidgetApprovedRequests();
		}
	...
	public GatekeeperWidgetApprovedRequests() {
		super();
		this.log.setCurrentClass(GatekeeperWidgetApprovedRequests.class.getName());
		this.initialise();
	}
