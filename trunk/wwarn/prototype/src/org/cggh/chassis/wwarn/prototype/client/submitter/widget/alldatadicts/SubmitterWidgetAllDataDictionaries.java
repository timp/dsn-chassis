 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.submitter.widget.alldatadicts;
 ...
 *
 */
public class SubmitterWidgetAllDataDictionaries extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new SubmitterWidgetAllDataDictionaries();
		}
	...
	public SubmitterWidgetAllDataDictionaries() {
		super();
		this.log.setCurrentClass(SubmitterWidgetAllDataDictionaries.class.getName());
		this.initialise();
	}
