 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.coordinator.widget.approvedreqs;
 ...
 *
 */
public class CoordinatorWidgetApprovedSubmissionRequests extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CoordinatorWidgetApprovedSubmissionRequests();
		}
	...
	public CoordinatorWidgetApprovedSubmissionRequests() {
		super();
		this.log.setCurrentClass(CoordinatorWidgetApprovedSubmissionRequests.class.getName());
		this.initialise();
	}
