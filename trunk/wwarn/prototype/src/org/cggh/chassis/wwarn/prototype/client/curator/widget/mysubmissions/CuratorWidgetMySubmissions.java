 ...
 * 
 */
package org.cggh.chassis.wwarn.prototype.client.curator.widget.mysubmissions;
 ...
 *
 */
public class CuratorWidgetMySubmissions extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CuratorWidgetMySubmissions();
		}
	...
	public CuratorWidgetMySubmissions() {
		super();
		this.log.setCurrentClass(CuratorWidgetMySubmissions.class.getName());
		this.initialise();
	}
