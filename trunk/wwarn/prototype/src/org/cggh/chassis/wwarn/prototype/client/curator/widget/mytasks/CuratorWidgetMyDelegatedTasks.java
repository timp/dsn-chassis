 ...
 *
 */
public class CuratorWidgetMyDelegatedTasks extends FractalUIComponent {
	...
	public static final Function<Object[],FractalUIComponent> creator = new Function<Object[],FractalUIComponent>() {
		...
		public FractalUIComponent apply(Object[] args) {
			return new CuratorWidgetMyDelegatedTasks();
		}
	...
	public CuratorWidgetMyDelegatedTasks() {
		super();
		this.log.setCurrentClass(CuratorWidgetMyDelegatedTasks.class.getName());
		this.initialise();
	}
