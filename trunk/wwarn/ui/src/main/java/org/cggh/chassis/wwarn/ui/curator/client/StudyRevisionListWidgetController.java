...
public class StudyRevisionListWidgetController {
	...
	private Deferred<Element> retrieveSubmission() {
		...
		model.status.set(StudyRevisionListWidgetModel.STATUS_RETRIEVE_SUBMISSION_PENDING);
...
//				model.studyEntryElement.set(studyEntryElement);
				...
				model.status.set(StudyRevisionListWidgetModel.STATUS_SUBMISSION_NOT_FOUND);
