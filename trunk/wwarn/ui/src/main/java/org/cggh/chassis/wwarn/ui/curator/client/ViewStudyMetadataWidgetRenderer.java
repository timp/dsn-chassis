 ...
 * @author timp
 */
public class ViewStudyMetadataWidgetRenderer extends
		ChassisWidgetRenderer<ViewStudyMetadataWidgetModel> {

	private Log log = LogFactory.getLog(ViewStudyMetadataWidgetRenderer.class);
	
	@UiTemplate("ViewStudyMetadataWidget.ui.xml")
	interface ViewStudyMetadataWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, ViewStudyMetadataWidgetRenderer> {
	}
