 ...
 * @author timp
 */
public class CurationSummaryWidgetRenderer extends
		ChassisWidgetRenderer<CurationSummaryWidgetModel> {
	...
	private CurationSummaryWidget owner;
	
    public CurationSummaryWidgetRenderer(CurationSummaryWidget owner) {
		this.owner = owner;	}
