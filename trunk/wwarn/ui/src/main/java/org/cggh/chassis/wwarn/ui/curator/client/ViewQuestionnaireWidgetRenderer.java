...
public class ViewQuestionnaireWidgetRenderer extends
		ChassisWidgetRenderer<ViewQuestionaireWidgetModel> {

	private Log log = LogFactory.getLog(ViewQuestionnaireWidgetRenderer.class);
	
	@UiTemplate("ViewQuestionnaireWidget.ui.xml")
	interface ViewQuestionaireWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, ViewQuestionnaireWidgetRenderer> {
	}
	private static ViewQuestionaireWidgetRendererUiBinder uiBinder = 
		GWT.create(ViewQuestionaireWidgetRendererUiBinder.class);
...
//	@UiField FlowPanel mainActionsPanel;
	...
	public ViewQuestionnaireWidgetRenderer(ViewQuestionaireWidget owner) {
		this.owner = owner;
	}

	public void setController(ViewQuestionaireWidgetController controller) {
