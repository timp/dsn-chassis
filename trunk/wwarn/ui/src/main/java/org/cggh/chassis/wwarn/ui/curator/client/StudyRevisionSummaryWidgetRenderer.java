 ...
 * @since 13 Jan 2010
 */
public class StudyRevisionSummaryWidgetRenderer extends
		ChassisWidgetRenderer<StudyRevisionSummaryWidgetModel> {

	private Log log = LogFactory.getLog(StudyRevisionSummaryWidgetRenderer.class);
	
	@UiTemplate("StudyRevisionSummaryWidget.ui.xml")
	interface StudyRevisionSummaryWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, StudyRevisionSummaryWidgetRenderer> {
	}
	private static StudyRevisionSummaryWidgetRendererUiBinder uiBinder = 
		GWT.create(StudyRevisionSummaryWidgetRendererUiBinder.class);
