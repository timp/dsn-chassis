 ...
 *
 */
public class PriorStudyRevisionsListWidgetController {

	
	
	
	private Log log = LogFactory.getLog(PriorStudyRevisionsListWidgetController.class);
	
	
	
	
	private PriorStudyRevisionsListWidget owner;
	private PriorStudyRevisionsListWidgetModel model;


	
	
	public PriorStudyRevisionsListWidgetController(PriorStudyRevisionsListWidget owner, PriorStudyRevisionsListWidgetModel model) {
		this.owner = owner;
		this.model = model;
	}
	...
	private Deferred<Element> retrieveSubmission() {
		...
		model.status.set(PriorStudyRevisionsListWidgetModel.STATUS_RETRIEVE_SUBMISSION_PENDING);
...
//				model.studyEntryElement.set(studyEntryElement);
				...
				model.status.set(PriorStudyRevisionsListWidgetModel.STATUS_SUBMISSION_NOT_FOUND);
...
*/
	...
	public Deferred<Element> retrieveStudy() {
		...
		model.status.set(PriorStudyRevisionsListWidgetModel.STATUS_RETRIEVE_STUDY_PENDING);
	...
	public final Function<Element, Element> retrieveStudyCallback = new Function<Element, Element>() {
		...
		public Element apply(Element in) {
			...
			model.status.set(PriorStudyRevisionsListWidgetModel.STATUS_READY_FOR_INTERACTION);
	...
	public void saveStudy() {
		...
		model.status.set(PriorStudyRevisionsListWidgetModel.STATUS_SAVE_STUDY_PENDING);
