 ...
 * @since 13 Jan 2010
 */
public class StudyFilesWidgetRenderer extends
		ChassisWidgetRenderer<StudyFilesWidgetModel> {

	private Log log = LogFactory.getLog(StudyFilesWidgetRenderer.class);
	
	@UiTemplate("StudyFilesWidget.ui.xml")
	interface StudyFilesWidgetRendererUiBinder extends
			UiBinder<HTMLPanel, StudyFilesWidgetRenderer> {
	}
	...
	public StudyFilesWidgetRenderer(StudyFilesWidget owner) {
		this.owner = owner;
	}

	public void setController(StudyFilesWidgetController controller) {
