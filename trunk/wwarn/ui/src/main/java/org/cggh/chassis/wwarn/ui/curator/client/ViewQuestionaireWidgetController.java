 ...
 *
 */
public class ViewQuestionaireWidgetController {

	
	
	
	private Log log = LogFactory.getLog(ViewQuestionaireWidgetController.class);
	
	
	
	
	private ViewQuestionaireWidget owner;
	private ViewQuestionaireWidgetModel model;


	
	
	public ViewQuestionaireWidgetController(ViewQuestionaireWidget owner, ViewQuestionaireWidgetModel model) {
		this.owner = owner;
		this.model = model;
	}
	...
	private Deferred<Element> retrieveSubmission() {
		...
		model.status.set(ViewQuestionaireWidgetModel.STATUS_RETRIEVE_SUBMISSION_PENDING);
...
//				model.studyEntryElement.set(studyEntryElement);
				...
				model.status.set(ViewQuestionaireWidgetModel.STATUS_SUBMISSION_NOT_FOUND);
...
*/
	...
	public Deferred<Element> retrieveStudy() {
		...
		model.status.set(ViewQuestionaireWidgetModel.STATUS_RETRIEVE_STUDY_PENDING);
	...
	public final Function<Element, Element> retrieveStudyCallback = new Function<Element, Element>() {
		...
		public Element apply(Element in) {
			...
			model.status.set(ViewQuestionaireWidgetModel.STATUS_READY_FOR_INTERACTION);
	...
	public void saveStudy() {
		...
		model.status.set(ViewQuestionaireWidgetModel.STATUS_SAVE_STUDY_PENDING);
