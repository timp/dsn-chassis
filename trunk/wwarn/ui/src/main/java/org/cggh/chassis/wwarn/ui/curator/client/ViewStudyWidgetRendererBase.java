...
public abstract class ViewStudyWidgetRendererBase extends ChassisWidgetRenderer<ViewStudyWidgetModel> {
	...
	private static ViewStudyWidgetRendererUiBinder uiBinder = GWT.create(ViewStudyWidgetRendererUiBinder.class);
	@UiField
	HTMLPanel mainPanel;
	@UiField
	HTMLPanel contentPanel;
	@UiField
	HTMLPanel pendingPanel;
	@UiField
	HTMLPanel errorPanel;
	@UiField
	FlowPanel errorMessage;
	@UiField
	FlowPanel viewStudyPanel;
	@UiField
	protected StudySummaryWidget studySummaryWidgetUiField;
	@UiField
	protected ViewStudyMetadataWidget viewStudyMetadataWidgetUiField;
	@UiField
	protected ListSubmissionsWidget listSubmissionsWidgetUiField;
	@UiField
	protected ListCurationsWidget listCurationsWidgetUiField;
