 ...
 *
 */
public class PostEntryResponseHandler implements RequestCallback {

	private PostEntryCallback callback;
	 ...
	 * @param factory
	 */
	public PostEntryResponseHandler(PostEntryCallback callback, AtomFactory factory) {
