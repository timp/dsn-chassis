...
public class StudyLocation {
	...
	StudyLocation(Element locationElement) {
		this.lat= XML.getElementSimpleContentByTagName(locationElement, ChassisNS.LAT);
		this.lon = XML.getElementSimpleContentByTagName(locationElement, ChassisNS.LON);
	}
