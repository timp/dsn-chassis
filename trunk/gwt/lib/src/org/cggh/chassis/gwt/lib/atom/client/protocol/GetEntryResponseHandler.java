 ...
 *
 */
public class GetEntryResponseHandler implements RequestCallback {

	private GetEntryCallback callback;
	 ...
	 * @param factory
	 */
	public GetEntryResponseHandler(GetEntryCallback callback, AtomFactory factory) {
