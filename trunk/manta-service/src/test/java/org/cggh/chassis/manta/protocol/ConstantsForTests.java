...
public class ConstantsForTests {
	...
	public static final String URL_CONTENT_CONTEXT_ROOT = "repository";
	public static final String URL_LOCAL_CONTEXT_ROOT = "repo";
	public static final String URL_SERVICE_BASE = "http://localhost:11901/"+URL_LOCAL_CONTEXT_ROOT+"/service";
