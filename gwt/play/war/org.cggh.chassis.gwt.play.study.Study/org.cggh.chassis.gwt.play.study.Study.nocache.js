function org_cggh_chassis_gwt_play_study_Study(){
  var $intern_0 = '', $intern_27 = '" for "gwt:onLoadErrorFn"', $intern_25 = '" for "gwt:onPropertyErrorFn"', $intern_10 = '"><\/script>', $intern_12 = '#', $intern_14 = '/', $intern_48 = '10638AAE56F03B4D142F6B55DAF92551.cache.html', $intern_44 = '12F39869FB6D6C5DB0FA9D9C74E5FCC7.cache.html', $intern_46 = '26C59C397BCEA8B40C77A911AC4E5DD9.cache.html', $intern_45 = '31BE5ED6FBD400BA84F88D3F07D046F1.cache.html', $intern_50 = '<script defer="defer">org_cggh_chassis_gwt_play_study_Study.onInjectionDone(\'org.cggh.chassis.gwt.play.study.Study\')<\/script>', $intern_9 = '<script id="', $intern_22 = '=', $intern_13 = '?', $intern_24 = 'Bad handler "', $intern_47 = 'D9F885576EEE05869243CBAC449FCE86.cache.html', $intern_49 = 'DOMContentLoaded', $intern_11 = 'SCRIPT', $intern_8 = '__gwt_marker_org.cggh.chassis.gwt.play.study.Study', $intern_15 = 'base', $intern_4 = 'begin', $intern_3 = 'bootstrap', $intern_17 = 'clear.cache.gif', $intern_21 = 'content', $intern_7 = 'end', $intern_38 = 'gecko', $intern_39 = 'gecko1_8', $intern_5 = 'gwt.hybrid', $intern_26 = 'gwt:onLoadErrorFn', $intern_23 = 'gwt:onPropertyErrorFn', $intern_20 = 'gwt:property', $intern_42 = 'hosted.html?org_cggh_chassis_gwt_play_study_Study', $intern_37 = 'ie6', $intern_28 = 'iframe', $intern_16 = 'img', $intern_29 = "javascript:''", $intern_41 = 'loadExternalRefs', $intern_18 = 'meta', $intern_31 = 'moduleRequested', $intern_6 = 'moduleStartup', $intern_36 = 'msie', $intern_19 = 'name', $intern_33 = 'opera', $intern_1 = 'org.cggh.chassis.gwt.play.study.Study', $intern_30 = 'position:absolute;width:0;height:0;border:none', $intern_35 = 'safari', $intern_43 = 'selectingPermutation', $intern_2 = 'startup', $intern_40 = 'unknown', $intern_32 = 'user.agent', $intern_34 = 'webkit';
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      ...
      org_cggh_chassis_gwt_play_study_Study = null;
  ...
  org_cggh_chassis_gwt_play_study_Study.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  org_cggh_chassis_gwt_play_study_Study.onInjectionDone = function(){
    scriptsDone = true;
  ...
  if (!strongName) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_38], $intern_47);
  ...
  function onBodyDone(){
    if (!bodyDone) {
      ...
      if ($doc.removeEventListener) {
        $doc.removeEventListener($intern_49, onBodyDone, false);
      }
  ...
  if ($doc.addEventListener) {
    $doc.addEventListener($intern_49, function(){
      maybeInjectFrame();
      onBodyDone();
    }
    , false);
...
org_cggh_chassis_gwt_play_study_Study();
