             ...
             -->
                    ...
                    <invitro>
                        ...
                        <drugSusceptibilityMedium>
                            ...
                            <NaHCO3-finalConcentration>2.008 mM</NaHCO3-finalConcentration>
                            <hypoxantine>
                                <hypoxantine-added/>
...
declare function local:content($content) as item()*
{
    ...
    return
        ...
        <html>
            <head>
                <title>Data Migration - Study Info v2.1 to v2.2</title>
            </head>
            <body>
                <h1>Data Migration - Study v2.1 to v2.2</h1>
                ...
                <p>Number of entries in <a href="../../content/studies">Studies</a> collection using v2.2 profile: <strong>{ count( $new-study-infos ) }</strong></p>
                <p>
...
declare function local:get-new-versioned-content($study-infos) as element( atom:entry )* {
    ...
    let $ret := $study-infos[atom:content/study/@profile='http://www.cggh.org/2010/chassis/manta/2.2']
    return $ret
};
...
declare function local:modify-nodes($old-study-infos) as element( atom:entry )*
{
   ...
   let $new-study-infos := 
        for $old in $old-study-infos
            let $profile := update replace $old//study/@profile with "http://www.cggh.org/2010/chassis/manta/2.2"
