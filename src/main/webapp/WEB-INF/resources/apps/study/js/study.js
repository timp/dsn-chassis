...
function retrieveStudyCustomFieldLabelsRegExMapAsAssociativeArray () {
	...
	studyCustomFieldLabelsMapAsAssociativeArray = {
			...
			"atom:entry\\[(\\d+)\\]/atom:content\\[(\\d+)\\]/study\\[(\\d+)\\]/acknowledgements\\[(\\d+)\\]/institutions/institution-ack\\[(\\d+)\\]/institution-name\\[(\\d+)\\]" : "ackInstitute$5",
			"atom:entry\\[(\\d+)\\]/atom:content\\[(\\d+)\\]/study\\[(\\d+)\\]/acknowledgements\\[(\\d+)\\]/institutions/institution-ack\\[(\\d+)\\]/institution-websites\\[(\\d+)\\]/institution-url\\[(\\d+)\\]" : "ackInstitute$5URL",
